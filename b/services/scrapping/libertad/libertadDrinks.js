...
exports.libertadDrinks = async () => {
  try {
    ...
    console.log(`✅ Libertad Bebidas: ${allProducts.length} productos obtenidos`);
    return allProducts;

  } catch (err) {
    console.error("Error en libertadStore Bebidas:", err.message);
    return [];
  }
};
