...
exports.libertadPets = async () => {
  try {
    ...
    console.log(`✅ Libertad mascotas: ${allProducts.length} productos obtenidos`);
    return allProducts;

  } catch (err) {
    console.error("Error en libertadStore mascotas:", err.message);
    return [];
  }
};
