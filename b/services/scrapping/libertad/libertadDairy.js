...
exports.libertadDairy = async () => {
  try {
    ...
    console.log(`✅ Libertad Lácteos: ${allProducts.length} productos obtenidos`);
    return allProducts;

  } catch (err) {
    console.error("Error en libertadStore lácteos:", err.message);
    return [];
  }
};
