...
// Configuración
const slug_data = "lacteos"
const filter_data = "dairy"
const MAX_RETRIES = 3;
...
exports.neneDairy = async () => {
  ...
  try {
    ...
    console.log(`✅ nene (Lacteos): ${allProducts.length} productos obtenidos en ${sessionCounter} sesiones`);
    return allProducts;
