...
// Configuración
const slug_data = "limpieza"
const filter_data = "cleaning"
const MAX_RETRIES = 3;
...
exports.neneCleaning = async () => {
  ...
  try {
    ...
    console.log(`✅ neneStore (Limpieza): ${allProducts.length} productos obtenidos en ${sessionCounter} sesiones`);
    return allProducts;
