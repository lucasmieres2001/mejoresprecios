...
// Configuración
const slug_data = "verduleria/frutas-y-verduras"
const filter_data = "fruits"
const MAX_RETRIES = 3;
...
exports.neneFruitsVegetables = async () => {
  let allProducts = [];
  let seenIds = new Set();
  let from = 0;
  ...
  try {
    ...
    console.log(`✅ nene (vegetales) ${allProducts.length} productos obtenidos en ${sessionCounter} sesiones`);
    return allProducts;
