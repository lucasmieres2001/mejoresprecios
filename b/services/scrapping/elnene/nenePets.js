...
// Configuración
const slug_data = "limpieza/prod--mascotas"
const filter_data = "pets"
const MAX_RETRIES = 3;
...
exports.nenePets = async () => {
  ...
  try {
    ...
    console.log(`✅ nene (mascotas): ${allProducts.length} productos obtenidos en ${sessionCounter} sesiones`);
    return allProducts;
