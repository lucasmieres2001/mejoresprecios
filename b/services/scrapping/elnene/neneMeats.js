...
// Configuración
const slug_data = "carniceria"
const filter_data = "meats"
const MAX_RETRIES = 3;
...
exports.neneMeats = async () => {
  ...
  try {
    ...
    console.log(`✅ nene (carnes): ${allProducts.length} productos obtenidos en ${sessionCounter} sesiones`);
    return allProducts;
