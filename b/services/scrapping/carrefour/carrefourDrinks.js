...
exports.carrefourDrinks = async () => {
  ...
  try {
    ...
    const drinkList = allProducts.map(products => {
    ...
    //console.log('Productos de Carrefour obtenidos:', drinkList);
    console.log(`Cantidad de productos de bebidas: ${drinkList.length} / ${total}`);

    return { bebidas: drinkList };
