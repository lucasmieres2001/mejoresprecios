...
exports.cotoDrinks = async () => {
  ...
  while (true) {
    const url = `https://www.cotodigital.com.ar/sitios/cdigi/categoria/catalogo-bebidas/_/N-1c1jy9y?Nf=product.endDate|GTEQ 1.755216E12||product.startDate|LTEQ 1.755216E12&Nr=AND(product.sDisp_200:1004,product.language:español,OR(product.siteId:CotoDigital))&No=${offset}&Nrpp=${pageSize}&format=json`;
